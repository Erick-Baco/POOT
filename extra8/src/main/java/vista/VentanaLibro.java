...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(0xFCABAB));
        lblid = new JLabel("ID: ");
        ...
        panel2.setBackground(new Color(0xFFE984));
        ...
        panel3.setBackground(new Color(0x76FA76));
        //panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(0x86ECEC));
